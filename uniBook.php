    ...
    <body>
        ...
        <div id="content" class="content">
            <div class="container">
                ...
                <div class="col-md-9">
                    <div class="box">
                           <h1>Book Shop(University Book)</h1>
                        <h4>You can order university book.</h4>
                        <p>
                        ...
                        <?php
                                        ...
                                        $count = 0;
                                                 ...
                                                 while ( $data = $result->fetch_assoc()) {
                                                    ...
                                                    if($level_scl_clg_uni == "University Book" ){
                                                        $count++;
                                                    echo "
                                            ...
                                            if($count==0){
                                                    ...
                                                    echo "<h3 class='noBk'>No books available here!</h3>";
