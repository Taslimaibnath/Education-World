...
var c = 0;
var c1 = 0,c2=0,c3=0,c4=0,c5=0,c7=0,c8=0,c9=0,c5=10,c11=0,c12=0,c13=0,c14=0
...
recognition.addEventListener('result', (e) => {
    ...
    if (text.includes('tell me about the faculty member of United International University') ||  text.includes('tell me about Faculty of United International University')||text.includes('tell me about faculty member of united international university') ||text.includes('faculty member of united international university') ) {
      p = document.createElement('p');
      p.classList.add('replay');
    ...
    // tell mee part end
            ...
            if (text.includes('robot go to your page') || text.includes('your page')) {
                window.location.href = 'robot2.php'
            }
            ...
            if (text.includes('go to study abroad')|| text.includes('go to study abroad page')  || text.includes('go to study about') || text.includes('go to higher study')) {
                window.location.href = 'studyAbroad.php'

            }

            if (text.includes('go to login') || text.includes('go to Login')) {
                window.location.href = 'login.php'// you have already login 
            }
            ...
            if (text.includes('go to uiu')|| text.includes('go to United International University website') || text.includes('go to united international university website') || text.includes('go to united international university') || text.includes('go to United International University')) {
