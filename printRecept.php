            ...
            <div class="container1">
                        ...
                        <div class="content">
                            <form action="tuition.php" method="post">
                                <div class="user-details">
                                    ...
                                    <div class="input-box">
                                        ...
                                        <input type="text" name="sl_clg_un" placeholder="School/college/University*" required>
                                    </div>
                                    <div class="input-box">
                            ...
                            if (isset($_POST['postt'])) {
                                ...
                                $sql = "INSERT INTO student (name,email,phone,address,class,day_time,sl_clg_un,subject,designation,salary,version, img)
                                    VALUES('$s_name','$s_email','$s_Phone','$s_address','$class','$day_time','$sl_clg_un','$subject','$designation','$amount', '$version','$s_img')";
                ...
                <div class="main-content">
                            ...
                            <div class="container">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="card-body p-0">
                                        <div id="box-rctp" class="table-responsive table-scroll" data-mdb-perfect-scrollbar="true" style="position: relative; height: 700px">
                                        <table class="table table-striped mb-0">
                                            <thead style="background-color: #002d72;">
                                            <tr>
                                                <th class="hdr" scope="col" colspan="2" >Money Receipt</th>
                                                <!-- <th scope="col">Bejoy Munshi</th> -->
                                            </tr>
                                            </thead>
                                            <tbody>
                        ...
                        <div class="download_btn">
                            <center>
                                 <button type="button" onclick="printPage('box-rctp')" class="btn btn-primary text-center">Download Receipt</button>
                            </center>
                        </div>
                   <!-- middle-side end -->
