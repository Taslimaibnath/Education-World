    ...
    <body>
        ...
        <nav class="socialNav">
            <div class="nav-left">
                ...
                <ul>
                    <li class="act"> <a href="myPostLone.php">My post</a> </li>
                </ul>
        ...
        <div class="container1">
            ...
            <div class="main-content">
                ...
                <?php
                        ...
                        $sql = "SELECT* FROM loanposttrk ORDER BY time DESC";
                        ...
                        while ($data = $result->fetch_assoc()) {
                            ...
                            if($email == $sl_email && $loneType_fatch == "Provide"){
                                $deletIds = $id;
                                $c++;
                                        ...
                                        echo "
                                                    ...
                                                    <div class='post-row'>
                                                        ...
                                                        <a href='deletLoanPost.php?dltId=$deletIds'><img src='pic/dlt.png' class='dltPst' alt='No img' ></a>                 
                            ...
                            if($email == $sl_email && $loneType_fatch == "Take"){
                                $deletId = $id;
                                $c++;
                                ...
                                echo "
                                            ...
                                            <div class='post-row'>
                                                ...
                                                <a href='deletLoanPost.php?dltId=$deletId'><img src='pic/dlt.png' class='dltPst' alt='No img' ></a>                 
                                                            <a target='_blank' href='https://twitter.com/kamildyrek'><svg
                                                                    style='width:2em;height:2em;position:fixed;top:1em;left:1em;opacity:.8;'
                                                                    viewBox='0 0 24 24'>
                                                                    <path fill='#fff'
