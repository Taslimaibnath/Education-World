 ...
 <div class="main">
          ...
          <div class="cardBox">
                ...
                <div class="container">
                  ...
                  <h4 class="hdr">Update Book Information</h4>
                    <div class="row fstNms">
                    
                      <div class="input-group input-group-icon">
                        <label for="">Book Name</label>
                        <input type="text" value="<?php echo "$peoduct_name" ?>" class="inpPNm" name="peoduct_name" required placeholder="Book Name"/>
                      
                      </div>
                      <div class="input-group input-group-icon">
                      <label class="wr">Writer Name</label>
                        <input type="text" value="<?php echo "$writer_name" ?>" class="inpNm" name="writer_name" required placeholder="Writer Name"/>
                    ...
                    <div class="input-group input-group-icon">
                      ...
                      <input type="text" value="<?php echo "$product_price" ?>" class="inpPNm" name="product_price" required placeholder="Book Price"/>
                      
                    </div>
                    <div class="input-group input-group-icon">
                    <label class="wr">Discount</label>
                      <input type="text" value="<?php echo "$discount" ?>" class="inpNm" name="discount" placeholder="Discount"/>
                  ...
                  <div class="row fstNms">
                    ...
                    <div class="input-group input-group-icon">
                      <label for="">Select Book Level</label>
                          ...
                          <input type="text" class="inpPNm bks" value="<?php echo "$level_scl_clg_uni" ?>" name="level_scl_clg_uni" placeholder="Scl/Clg/Uni"/>
                    
                    </div>
                    <div class="input-group input-group-icon">
                    <label class="wrBk">Number of Book(s)</label>
                    <input type="text" class="inpPNm bks" value="<?php echo "$stock_product" ?>" name="stock_product" required placeholder="Number of Book(s)"/>
                  ...
                  <div class="row fstNms">
                      ...
                      <button class ="ab" name="up" type="submit" >Update</button>
                        <div class="iconss">
                ...
                <?php 
                    ...
                    if(isset($_POST['up'])){
                      ...
                      $sql =   "UPDATE product 
                      SET peoduct_name='$peoduct_name',	writer_name='$writer_name',	product_price='$product_price',	stock_product='$stock_product'
                      ,	discount='$discount',	level_scl_clg_uni='$level_scl_clg_uni' WHERE id ='$idd' ";
