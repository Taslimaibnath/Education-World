                                ...
                                <div class="main-content">
                                    ...
                                    <div class = container_3>
                                        ...
                                        <div id="popup-box-chat" class="modal11">
                                            ...
                                            <div class="img_cont">
                                                <img src="up_img/<?php echo"$get_img"; ?>"
                                            ...
                                            <form class="msgFrm" method="post">
                                               ...
                                               <button type="submit" name="send" > <span class="input-group-text send_btn"><i
                                                       ...
                                                       //  $get_phn_num = $_GET['phone'];
                                                         ...
                                                         if ($_GET['phone']) {
                                                            ...
                                                            if (isset($_POST['send'])) {
                                                                ...
                                                                function RSAencryptText2($text, $key) {
                                                                ...
                                                                while ($data = $result->fetch_assoc()) {
                                                                    ...
                                                                    if ($log_usr_phone == $Phone) {
                                                                        $msge = RSAencryptText2($msges, $pkey);
                                                                        $sqlin="INSERT INTO massege(name, email,msg, img, send_phn, rec_phn,publicKey,privateKey)
                                                                        values('$log_usr_name','$log_usr_email','$msge','$log_usr_img','$log_usr_phone','$get_phn_num','$pkey' ,'$pkey')";
	
                                                                              $resultin = $conn->query($sqlin);
                                                                              echo "<script>window.location.href ='msg.php?phone=$get_phn_num';</script> ";
                                                                              exit();
                                                                        ...
                                                                        $msge = RSAencryptText2($msges, $pkey);
                                                                        $sqlin="INSERT INTO massege(name, email,msg, img, send_phn, rec_phn,publicKey,privateKey)
                                                                             values('$add_prsn_name','$add_prsn_email','$msge','$add_usr_img','$add_prsn_phone','$get_phn_num','$pkey' ,'$pkey')";
                                                                              $resultin = $conn->query($sqlin);
                                                                              echo "<script>window.location.href ='msg.php?phone=$get_phn_num';</script> ";
                                                                              exit();
