    ...
    <body>
        ...
        <div class="container1">
            ...
            <div class="main-content">
                ...
                $sql_al = "SELECT* FROM studentloanuserinfo";
                $result_al = $conn->query($sql_al);
                while ($data = $result_al->fetch_assoc()) {

                    $email_log = $data['email'];
                    $loneTypee = $data['loneType'];

                    if ($email == "$email_log" && $loneTypee != "Null") {
                        $c++;
                        $sql = "SELECT* FROM loanpost ORDER BY time DESC";
                        ...
                        while ($data = $result->fetch_assoc()) {
                            ...
                            if ($email != $sl_email && $loneType_fatch != $loneTypee) {
                                if ($loneType_fatch == "Provide") {
                                    $takeUserId =  $id;
                                    echo "
                                                            ...
                                                            <div class='post-row'>
                                                                ...
                                                                <a class='aplyBtn' href='applyLoan.php?id=$takeUserId'><img src='pic/apply.png' class='dltPst' alt='No img' >Apply</a>                 
                                    ...
                                    echo "
                                            ...
                                            <p>Amount : $amount</p>
                                                        ...
                                                        <div class='post-row'>
                                                            ...
                                                            <a class='aplyBtn' href='applyLoan.php?id=$provideUserId'><img src='pic/apply.png' class='dltPst' alt='No img' >Apply</a>                 
                                                                <a target='_blank' href='https://twitter.com/kamildyrek'><svg
                                                                        style='width:2em;height:2em;position:fixed;top:1em;left:1em;opacity:.8;'
                                                                        viewBox='0 0 24 24'>
                                                                        <path fill='#fff'
                ...
                if ($c == 0) {
                    echo "<h4 class='error' >Welcome to student loan. You have to update your profile.</h4>";
                }
            ...
            <div class="right-sidebar">
                <div class="video">
                    <iframe width="294" height="400" src="https://www.youtube.com/embed/LlbljkO9iy8?autoplay=1&mute=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
            </div>
            <!-- right-side end -->
        </div>
