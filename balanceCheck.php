    ...
    <body>
        ...
        <div class="container1">
            ...
            <div class="main-content">
                ...
                $sql_al = "SELECT* FROM sign_up where email = '$email' ";
                $result_al = $conn->query($sql_al);
                while ($data = $result_al->fetch_assoc()) {

                    $amountBks = $data['amountBks'];
                    $amountNgd = $data['amountNgd'];
                }

                echo "
                        <div class='crntBlc'>
                            <p>Bkash Current Balance : $amountBks BDT</p>
                            <p>Nagad Current Balance : $amountNgd BDT</p>
                        </div>
                ";
