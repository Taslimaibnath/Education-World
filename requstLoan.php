    ...
    <body>
        ...
        <nav class="socialNav">
            <div class="nav-left">
                ...
                <ul>
                    <li class="act"> <a href="requstLoan.php">Request</a> </li>
                </ul>
        ...
        <div class="container1">
            ...
            <div class="main-content">
                <h3 class="myPst">All request loan</h3>
                <hr>
                    ...
                    <div class="tab-content">
                        ...
                        <div id="menu2" >
                            ...
                            <div class="main-content">
                                ...
                                $sql_al = "SELECT * FROM `allapplyloan` ORDER BY `allapplyloan`.`msg` ASC";
                                                        ...
                                                        if ($loneType == "Take") {
                                                            ...
                                                            echo "
                                                                ...
                                                                <div class='rqstDiv'>
                                                                    ...
                                                                    <div class='infoRq'>
                                                                        <p>Name : $a_name</p>
                                                                        <a href='details.php?email=$a_email'>Details</a>
                                                                    </div>
                                                                        
                                                                    <p class='cmnts'>Comment : <img class='cmtImg' src='up_img/$a_img'>  $msgRqst</p>
                                                                ...
                                                                <div class='post-row'>
                                                                        ...
                                                                        <button style='--content: 'Accept';' name='done' href='https://twitter.com/kamildyrek'>
                                                                            <div class='left'></div>
                                                                            <a href='add2.php?St_email=$loginUserEmail&jobId=$applyPostNum'>Accept</a>
                                                                            <div class='right'></div>
                                                                        </button>

                                                                        <button style='--content: 'Accept';' name='done' href='https://twitter.com/kamildyrek'>
                                                                        <div class='left'></div>
                                                                        <a href='Reject2.php?St_email=$loginUserEmail&jobId=$applyPostNum'>Reject</a>
                                                                        <div class='right'></div>
                                                                    </button>
                                ...
                                if ($c == 0) {
                                    echo "<h4 class='error' >No request yet</h4>";
                                }
                                ?>
