    ...
    <body>
        ...
        <nav class="socialNav">
            <div class="nav-left">
                ...
                <ul>
                    <li> <a href="applyHistory.php">Apply history</a> </li>
                </ul>
                <!-- <ul>
                        
                        <li> <a href="dashboard.php"><img src="socialmage/inbox.png" alt="" srcset="">Student</a> </li>
                    </ul> -->
            </div>
        ...
        <div class="container1">
            ...
            <div class="main-content">
                ...
                $c = 0;
                $numSrch = 0;
                $sql_al = "SELECT* FROM tution_user_info";
                ...
                while ($data = $result_al->fetch_assoc()) {
                    ...
                    if ($email == $email_log) {
                        ...
                        $designation_log = $data['designation'];
                    }
                }

                $sql = "SELECT* FROM student ORDER BY DateTime DESC";
                ...
                while ($data = $result->fetch_assoc()) {
                    ...
                    $case1 = strtolower($address);
                    $case2 = strtolower($class);
                    $case3 = strtolower($subject);

                    if (($sl_email == $email)) {

                        if ($designation_log == "EMPTY" || $designation_log == "NULL" || empty ($designation_log)) {
                            $c++;
                        } else {
                            if ($designation == $designation_log) {
                                ...
                                if ($designation == "teacher") {
                                    ...
                                    $dl_id = $id;
                                    if(($case1 == $value)|| ($case2 == $value) || ($case3 == $value)){
                                        $numSrch++;
                                    echo "
                                                                        ...
                                                                        <a href='#popup-box2'><img src='pic/dlt.png' class='dltPst' alt='No img' ></a>                 
                                    ...
                                    echo "
                                                                                    ...
                                                                                    <div class='top-mid'>
                                                                                        <p class='post-text'>Want to read</p>
                                                                                        <div class='imgloc'>
                                                                                            <img src='pic/loc.png' alt='logo'>
                                                                                            Location : $address
                                                                                        </div>
                                                                                    ...
                                                                                    <div class='mid_info'>
                                                                                        ...
                                                                                        <div class='mn_info' >
                                                                                            <p>Salary : $salary TK/Month</p>
                                                                                        </div>
                                                                                    </div> 
                                                    
                                                                                    
                                                                                    <img src='pic/crs2.jpg' class='post-img' alt='No img' >
                                                                                    <div class='post-row'>
                                                                                        <div class='active-icon'>
                                                                                        <a href='#popup-box2'><img src='pic/dlt.png' class='dltPst' alt='No img' ></a>   
                                                                                        ...
                                                                                        <div class='active-icon'>
                                                                                            ...
                                                                                            <button style='--content: 'Accept';' name='done' href='https://twitter.com/kamildyrek'>
                                                                                                <div class='left'></div>
                                                                                                    ...
                                                                                                    <a href='addteach.php?tchr_id=$acceptTeachId'>Request</a>
                                                                                        ...
                                                                                        <div class='mid_info'>
                                                                                            ...
                                                                                            <div class='post-row'>
                                                                                                <div class='active-icon'>
                                                                                                    ...
                                                                                                    <button style='--content: 'Accept';' name='done' href='https://twitter.com/kamildyrek'>
                                                                                                        <div class='left'></div>
                                                                                                        <a href='AddSt.php?std_id=$acceptIdstnt'>Apply</a>
                                                                                                        <div class='right'></div>
                                                                                                    </button>
                ...
                if ($c > 0) {
                    echo "<h4 class='error' >Welcome to tuition platform. You have to update your tuition profile.</h4>";
                }

                if ($numSrch == 0) {
                    echo "<h4 class='error' >!!!Not Found!!!</h4>";
                }
