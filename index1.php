...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="clk nav-link" onclick="showPopup()">Student Loan</a>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="cover">
                            <div class="container">
                                <div class="header-content">
                                    ...
                                    <h4 style="color: white">Scholarship available, 3 years work permit, good chance to get
                                        PR</h4>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="well well-trans" style="background:#ffffff00;color: white">
                                    <div class="wow fadeInRight" data-wow-delay="0.1s">
                                        ...
                                        <p class="text-right wow bounceIn" data-wow-delay="0.4s">
                                            <a href="learnMore.php" class="btn btn-skin btn-lg"
        ...
        <div id="popup" class="popup" style="display:none;"> 
            <p>Dear user you have to login first.</p>
