...
<!-- all poppup end-->
    ...
    while ($data = $result->fetch_assoc()) {
        ...
        $log_usr_status = $data['log_usr_status'];
        $log_sub = $data['log_sub'];
        $log_ins = $data['log_ins'];
        ...
        $add_prsn_status = $data['add_prsn_status'];
        ...
        if ($log_usr_phone == $Phone) {
            ...
            echo "
                                        ...
                                        <div class = card>
                                        <div class = image>
                                            <img href = '#'  src='up_img/$add_usr_img' alt='No picture'>
                                        ...
                                        <div class = content>
                                            ...
                                            <hr class='nmhr'>
                                                    <div class='dtlsIn'>
                                                        <p>Status : $add_prsn_status</p>
                                                        <p>Phone : $add_prsn_phone</p>
                                                        <p>Subject : $log_sub</p>
                                                        <p>Institute : $add_ins</p>
                                                    </div>
                                       </div>
                                    </div>
            ...
            echo "
                                        <div class = card>
                                        <div class = image>
                                            <img href = '#' src='up_img/$log_usr_img' alt='No picture'>
                                        ...
                                        <div class = content>
                                            ...
                                            <hr class='nmhr'>
                                                <div class='dtlsIn'>
                                                <p>Status : $log_usr_status</p>
                                                    <p>Phone : $log_usr_phone</p>
                                                    <p>Subject : $log_sub</p>
                                                    <p>Institute : $log_ins</p>
                                                </div>
    ...
    while ($data = $result->fetch_assoc()) {
        ...
        if ($log_usr_phone == $Phone) {
            ...
            $c++;
            $_SESSION['phn'] = $data['add_prsn_phone'];
            echo "
            ...
            $_SESSION['phn'] = $data['log_usr_phone'];
