...
if (!empty($passValueLoginPage)) {
    ...
    .nav.nav-tabs {
        display: inline-block; /* Displays the navigation tabs inline */
    }
    ...
    <body>
        ...
        <nav class="socialNav">
            <div class="nav-left">
                ...
                <ul>
                    <li class="act"> <a href="rqstStTs.php"><?php if($designations == "student"){echo "Applicant";}else{echo"Request";} ?></a></li>
                </ul>
        ...
        <div class="container1">
            ...
            <div class="main-content">
                <h3 class="myPst"><?php if($designations == "student"){echo "All Applicant Request";}else{echo"All Request";} ?></h3>
                <hr>
                                ...
                                while ($data = $result_al->fetch_assoc()) {
                                    ...
                                    if ($email == $postEmail) {
                                        ...
                                        if ($decision == "Approved" || $decision == "Reject") {
                                            ...
                                            $sql5 = "SELECT* FROM tution_user_info";

                                            $result5 = $conn->query($sql5);

                                            while ($data = $result5->fetch_assoc()) {
                                                $allEmails = $data['email'];
                                                if ($allEmails == $apply_email) {
                                                    ...
                                                    $sl_clg_un = $data['institut'];
                                                }


                                            }

                                            $sql = "SELECT* FROM trackallpost ORDER BY DateTime DESC";
                                                ...
                                                if ($postEmail == $email_all) {
                                                    ...
                                                    if ($designation == "teacher") {
                                                        echo "
                                                                                                ...
                                                                                                <div class='left'></div>
                                                                                                <a href='add.php?St_email=$sl_email&jobId=$jobId'>Accept</a>
                                                                                                <div class='right'></div>
                                                                                            </button>

                                                                                            <button style='--content: 'Accept';' name='done' href='https://twitter.com/kamildyrek'>
                                                                                            <div class='left'></div>
                                                                                            <a href='Reject.php?St_email=$sl_email&jobId=$jobId'>Reject</a>
                                                                                            <div class='right'></div>
                                                                                        </button>
                    ...
                    <form method="post">
                        <div class="user-details">
                            ...
                            <div class="input-box">
                                ...
                                <input type="text" name="day_time" placeholder="Example : Sunday&Tuesday (7 PM)" required>
                            </div>
