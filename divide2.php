    ...
    <body>
        ...
        <header>
            <div class="container">
                <div class="nav1">
                    ...
                    <nav>
                        <ul>
                            <li><a href="mathGame2.php">Add</a></li>
                            <li><a href="subtract2.php">Subtract</a></li>
                            <li><a href="multiply2.php">Multiply</a></li>
                            <li class="current"><a href="divide2.php">Divide</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
            ...
            <div class="equation">
                <div class="middleIlement">
                    <center>
                        ...
                        <h1 style="color: #2AB7CA;"><img class="divIcn" src="kidsPic/div.png" alt=""></h1>
        ...
        <script>
            ...
            function generate_equation() {
                ...
                Wr_answer = eval(num1 / num2);
                answer = Wr_answer.toFixed(1);
