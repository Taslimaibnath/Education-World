        ...
        <!-- social media nav design start -->
            <nav class="socialNav">
                    <div class="nav-left">
                        ...
                        <ul>
                        <li> <a href="dashboard.php">Message</a> </li>
                    </ul>
                ...
                <ul>
                    ...
                    <div class="nav-right">
                        ...
                        <div class="nav-user-icon online">
                            <img src="up_img/<?php echo "$s_img" ?>" alt="No picture" srcset=""> <?php echo " $designations" ?>
                        </div>
            ...
            <div class="container1">
                <!-- left-side start -->
                    <div class="left-sidebar">
                        <div class="imp-links">
                            <a href="socialMyAcc.php"><img src="socialmage/acc.png" alt=""><?php echo "$name" ?></a>
                            <a class="active" href="dashboard.php"><img src="socialmage/friends.png" alt="">Student/Teacher</a>
                        ...
                        <div class="shortcut-links">
                            ...
                            <a href="https://www.udemy.com/course/ultimate-web/?gad_source=1&gclid=Cj0KCQiAwP6sBhDAARIsAPfK_wbkon7GZMWxzQ91n3vgGm1Xu8dJ5rl_v7ayoYcrTSF2-uIoucicQFsaAtrlEALw_wcB&matchtype=b&utm_campaign=WebDevelopment_v.PROF_la.EN_cc.ROW_ti.8322&utm_content=deal4584&utm_medium=udemyads&utm_source=adwords&utm_term=_._ag_80385736515_._ad_535757876393_._kw_web+development+course_._de_c_._dm__._pl__._ti_kwd-306481538064_._li_1001441_._pd__._"><img src="socialmage/shortcut-2.webp" alt="">Web Development </a>
                            <a href="https://developer.android.com/courses?gclid=Cj0KCQiAhomtBhDgARIsABcaYyluDSKX9CvJpCk7-s6YdH3zP4WIXA-xgnWzP4m-iylfi-pFIw5tMzoaAvAhEALw_wcB&gclsrc=aw.ds"><img src="pic/app.gif" alt="">Mobile App Development</a>
                    ...
                    <div class="proImg">
                        ...
                        <form active="socialMyAcc.php" method="post" enctype="multipart/form-data" >
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="address" value="<?php echo "$address" ?>" required class="form-control" id="">
                            </div>

                            <div class="mb-3">
                                <div class="gender-details">
                                    <input type="radio" name="designation" value="student" id="dot-1">
                                    <input type="radio" name="designation" value="teacher" id="dot-2">

                                    <span class="gender-title">Designation</span>
                                    <div class="category">
                                        <label for="dot-1">
                            ...
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">School/College/University*</label>
                                <input type="text" name="institut" value="<?php echo "$institut" ?>" required class="form-control" id="">
                            </div>
                        ...
                        <?php 
                            ...
                            if(isset($_POST['up'])){
                                ...
                                $sql =   "UPDATE tution_user_info 
                                SET name='$name', email='$email', mobile='$mobile', address='$address', designation='$designation', institut='$institut', img='$img' WHERE id='$s_id' ";
                            
                                $result = $conn->query($sql);

                                $sql2 =   "UPDATE student 
                                SET name='$name', email='$email', phone='$mobile', address='$address',designation='$designation', img='$img', sl_clg_un='$institut' WHERE phone='$Phone' ";
                            
                                $result2 = $conn->query($sql2);

                                $sql3 =   "UPDATE sign_up 
                                SET name='$name', email='$email', phone='$mobile', img='$img' WHERE Phone='$Phone' ";
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" id="visa-tab" data-toggle="tab" href="#visa" role="tab"
                                aria-controls="visa" aria-selected="true"> <img class="bks"
                                    src="pic/bk.png" width="80">
                            </a>
                        </li>
                        <li class="nav-item" role="presentation">
                    ...
                    ?>
                                ...
                                <div class="form mt-3">
                                    <form  method="post">
                                            ...
                                            <div class="inputbox">
                                                <input type="text" name="given_amount" min="1" max="999" class="form-control"
                                                    required="required">
                                                <span>
                                                    Tk-BDT
                                                </span> 
                                            ...
                                            <div class="d-flex flex-row">
                                                <div class="inputbox slt"> <select class="form-select" id="month" name="month" required >
                            ...
                            <div class="text-center upayT">
                                ...
                                <div class="form mt-3">
                                    <form  method="post">
                                            ...
                                            <div class="inputbox">
                                                <input type="text" name="given_amount_ngd" min="1" max="999" class="form-control"
                                                    required="required">
                                                <span>
                                                    Tk-BDT
                                                </span> 
