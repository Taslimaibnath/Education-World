...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                ...
                <div class="robot">
                    <a href="robotExtra.php"> <img  src="pic/robot.png" style="width : 50px !important ;" class="rbt" alt=""></a>
                </div>
            </div>
        </nav>
        <!-- manu-bar end -->
            ...
            <div class="container">
                ...
                <div class="col-md-12">
                    ...
                    <center>
                        ...
                        <a href="snake.php"> <img class="imgTt" src="snakeMusic/snk.jpeg" alt="" srcset=""> </a>
                        <a href="mathGame.php"> <img  class="imgTt" src="snakeMusic/mt.gif" alt="" srcset=""> </a>
