    ...
    <body>
        ...
        <nav class="socialNav">
            <div class="nav-left">
                ...
                <ul>
                    <li class="act"> <a href="applyHistory.php"><?php if($designations == "student"){echo "My Request";}else{echo"My job apply";} ?></a> </li>
                </ul>
        ...
        <div class="container1">
            ...
            <div class="main-content">
                <h3 class="myPst"><?php if($designations == "student"){echo "My All Request";}else{echo"My All Job Request";} ?></h3>
                <hr>
                                                                                                ...
                                                                                                <div class='post-row'>
                                                                                                    ...
                                                                                                    <div class='right'></div>
                                                                                                                        ...
                                                                                                                        <div class='post-profile-icon'>
                                                                                                                                <a href='dltStd.php?jobId=$JOB_ID&email=$email'><img src='pic/dlt.png' class='dltPst' alt='No img' ></a>                 
