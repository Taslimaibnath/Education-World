        ...
        <body>
            ...
            <nav class="socialNav">
                <div class="nav-left">
                    ...
                    <ul>
                            <li class="act"> <a href="myPost.php">My post</a> </li>
                    </ul>
            ...
            <div class="container1">
                ...
                <div class="main-content">
                    ...
                    <hr>
                                ...
                                $sql = "SELECT* FROM student WHERE phone = $Phone ORDER BY DateTime DESC";
                                ...
                                $c++;
                                    ...
                                    <img src='up_img/$img' alt='No picture' >
                                        <div>
                                            <p>$name </p>
                                    ...
                                    <div class='top-mid'>
                                        <p class='post-text'>Want to teach</p>
                                        <div class='imgloc'>
                                            <img src='pic/loc.png' alt='logo'>
                                            Location : $address
                                        </div>
                                    </div>
                                    ...
                                    <div class='mid_info'>
                                        ...
                                        <div class='mn_info' >
                                            <p>Tuition time : $day_time</p>
                                        </div>
                                        <div class='mn_info' >
                                            <p>Tuition fee : $salary TK/Month</p>
                                        </div>
                                    </div>   

                                    <img src='pic/crs.webp' class='post-img' alt='No img' >       
                                    <div class='post-row'>
                                        <div class='active-icon'>
                                        
                                <a href='dltPost.php?id=$dl_id'><img src='pic/dlt.png' class='dltPst' alt='No img' ></a>                 
                                ...
                                if($c == 0){
                                    echo"<h4 class='error' >You have no post here.</h4>";
                                }
                                ?>
...
<!-- middle-side end -->
        ...
        <!-- right-side start -->
                <div class="right-sidebar">
                                <div class="video">
                                    <iframe width="297" height="400" src="https://www.youtube.com/embed/LlbljkO9iy8?autoplay=1&mute=1"
