...
if (!empty ($passValueLoginPage)) {
    ...
    height: 417px;
        ...
        <style>
            ...
            .cardCt {
                height: 430px border-radius: 15px !important;
                background-color: rgb(58 94 217) !important;
                overflow-y: auto;
                white-space: nowrap;
            }
    ...
    <body>
        ...
        <nav class="socialNav">
            <div class="nav-left">
                ...
                <ul>
                    <li class="act"> <a href="dashboardLoan.php">Message</a> </li>
                </ul>
                            ...
                            <div class="col-md-12 col-xl-12 chat">
                                <div class="card22">
                                    ...
                                    if ($_GET['phone']) {
                                        ...
                                        $sql = "SELECT* FROM studentloanuserinfo where mobile= $get_phn_num";
                                ...
                                if (isset ($_POST['send'])) {
                                    ...
                                    while ($data = $result->fetch_assoc()) {
                                        ...
                                        if($email == $login_email){
                                            ...
                                            $sql = "SELECT* FROM studentloanuserinfo WHERE  email = '$login_email' ";
                                            ...
                                            if ($query->num_rows > 0) {
                                                ...
                                                $log_usr_id = $data['id'];
                                                $log_usr_name = $data['name'];
                                                $log_usr_phone = $data['mobile'];
                                                $log_usr_email = $data['email'];
                                                $log_usr_img = $data['img'];
                                            ...
                                            $sqlin = "INSERT INTO massegeloan(name, email,msg, img, send_phn, rec_phn, publicKey,privateKey)
                                                values('$log_usr_name','$log_usr_email','$msge','$log_usr_img',
                                                '$log_usr_phone','$get_phn_num','$pkey' ,'$pkey')";

                                            $resultin = $conn->query($sqlin);
                                            echo "<script>window.location.href ='msgrLn2.php?phone=$get_phn_num';</script> ";
                                            exit();


                                        } else if($email == $apply_email){
                                            $sqls = "SELECT* FROM studentloanuserinfo WHERE  email = '$apply_email' ";
                                            ...
                                            if ($querys->num_rows > 0) {
                                                ...
                                                $add_prsn_id = $data['id'];
                                                $add_prsn_name = $data['name'];
                                                $add_prsn_phone = $data['mobile'];
                                                $add_prsn_email = $data['email'];
                                                $add_usr_img = $data['img'];
