...
<body>
            ...
            <div class="modal">
                        <div class="content1">
                                      <div class="title">Are you confirm you want to accept? 
                                    ...
                                    <div class="content">
                                        ...
                                        <form action="" method="post">
                                             ...
                                             //       $c = 0;
                                                ...
                                                $sql_in = "INSERT INTO all_record
                                                (log_usr_id,log_usr_name,log_usr_email,log_usr_status,log_usr_phone,log_usr_adrs,log_usr_img,log_usr_cl_nm,log_ins,add_prsn_id,add_prsn_name,add_prsn_email,add_prsn_phone,add_prsn_status,add_usr_img,add_usr_time,add_prns_cls,log_sub,add_sub,add_ins)
                                                VALUES('$s_id','$s_name','$s_email','$s_designation','$s_Phone','$s_address','$s_img','$add_class','$institut','$add_id','$add_name','$add_sl_email','$add_Phone','$add_designation','$add_img','$add_day_time','$add_class', '$add_subject', '$add_subject','$add_sl_clg_un')";
            
                                                $result_in = $conn->query($sql_in);


                                                $sqlup =   "UPDATE applyjob 
                                                SET decision='$cnfrm' WHERE applyEmail ='$St_email' AND postEmail = '$postEmail' ";
                                            
                                                $resultup = $conn->query($sqlup);

              
                                                    $sql = "DELETE FROM student WHERE id = '$jobId'";
                                                    $result = $conn->query($sql);

                                                    // $sqltk = "DELETE FROM trackallpost WHERE id = '$jobId'";
                                    ...
                                    <a href="applyHistory.php" class="box-close">
                                        ×
                                    </a>
                        </div>
            </div>
